...
`<81-digit string>`: The Sudoku puzzle represented as a string of 81 digits. The string list the digits of the Sudoku puzzle row by row. Zeros (`0`) indicate empty cells. For example the following Sudoku puzzle (from Sudoku.org.uk) collected on January 6th, 2025:
<p align="center">
  <img width="364" height="350" alt="image" src="https://github.com/ArmanE-V/Sudoku-Difficulty/blob/5560e753e4cb8c283c274c186984e041cff597e7/January_6th_Sudoku_example_used_in_README.png" />
</p>
